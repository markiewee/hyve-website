...
function SkeletonCard() {
  return (
    <div className="bg-white rounded-[2rem] p-8 border border-[#DDD0AD] shadow-sm space-y-4">
      <div className="h-5 w-1/3 bg-[#EAC25A] animate-pulse rounded" />
  ...
  return (
    <InvestorLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-12">
        ...
        <div className="md:col-span-4 bg-[#EAC25A] p-8 rounded-[2rem] flex flex-col justify-between relative overflow-hidden group">
          ...
          <div>
            ...
            {dashLoading ? (
              <div className="h-16 w-32 bg-[#F6E6B4] animate-pulse rounded mt-2" />
            ) : (
              <>
                <h3 className="font-['Hanken_Grotesk'] text-6xl font-black text-[#181511] mb-2">
          ...
          <div className="mt-8">
            <div className="h-1 w-full bg-[#DDD0AD] rounded-full overflow-hidden">
              <div
                className="h-full bg-[#A87813] rounded-full transition-all"
                style={{ width: `${Math.min(returnRate * 5, 100)}%` }}
              />
            </div>
            <div className="flex justify-between mt-2 text-[10px] font-bold font-['Inter'] text-[#57534E] uppercase tracking-tighter">
              <span>Target 15%</span>
        ...
        <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-[#DDD0AD]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-['Hanken_Grotesk'] font-bold text-[#181511]">Capital Contribution</span>
            </div>
            {dashLoading ? (
              <div className="h-10 w-40 bg-[#EAC25A] animate-pulse rounded" />
            ) : (
              <>
                <div className="flex items-baseline gap-2">
                  <span className="font-['Hanken_Grotesk'] text-4xl font-black text-[#181511]">
                    ${totalCapital.toLocaleString("en-SG", { minimumFractionDigits: 0 })}
                  </span>
                  <span className="font-['Inter'] text-sm text-[#DDD0AD]">SGD</span>
                </div>
                <p className="mt-4 font-['Inter'] text-sm text-[#57534E]">
          ...
          <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-[#DDD0AD]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-['Hanken_Grotesk'] font-bold text-[#181511]">Total Distributions</span>
            </div>
            {dashLoading ? (
              <div className="h-10 w-40 bg-[#EAC25A] animate-pulse rounded" />
            ) : (
      ...
      {investments.length > 0 && (
        <section className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h3 className="font-['Hanken_Grotesk'] text-2xl font-bold text-[#181511]">
              Portfolio Assets
            </h3>
          </div>
      ...
      <section className="bg-white rounded-[2rem] p-10 shadow-sm border border-[#DDD0AD]">
        ...
        {dashLoading ? (
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-12 bg-[#EAC25A] animate-pulse rounded-xl" />
            ))}
          </div>
        ) : (
