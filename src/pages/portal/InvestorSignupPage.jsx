...
export default function InvestorSignupPage() {
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription className="text-center">
              This investor invitation link is missing or invalid. Please contact Hyve
              for a valid invite link.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl text-center">Investor Portal Access</CardTitle>
          <CardDescription className="text-center">
            Create your Hyve investor account to view your portfolio and distributions.
          </CardDescription>
        </CardHeader>
        <CardContent>
