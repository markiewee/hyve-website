                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-semibold rounded-lg border transition-colors ${
                          sigMode === "saved"
                            ...
                            : "bg-white border-[#DDD0AD] text-[#57534E] hover:border-[#A87813]/40"
                        }`}
                      >
                        Use Saved Signature
                      </button>
          ...
          {onboarding.tenant_profiles && (
            <SectionCard title="Login Credentials">
              <div className="space-y-3">
                ...
                <div className="bg-[#FBF8F0] rounded-lg p-4 space-y-3 text-sm">
                  ...
                  <li key={c.id} className="py-3 flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-foreground flex items-center gap-2">
                        {c.description}
                        <span className="inline-flex px-1.5 py-0.5 rounded text-[10px] font-bold uppercase bg-[#EAC25A] text-[#57534E]">
          ...
          <SectionCard title="Member Actions">
            <div className="space-y-4">
              ...
              {onboarding.status !== "END_OF_TENANCY" && onboarding.status !== "ARCHIVED" && (
                <div className="flex items-center justify-between p-3 rounded-lg border border-[#DDD0AD]">
                  <div>
