      ...
      <section className="bg-white rounded-xl p-6 border border-[#DDD0AD] shadow-sm">
        ...
        {loading ? (
          <div className="space-y-3">
            {[1, 2, 3].map(i => (
              <div key={i} className="h-14 bg-[#EAC25A] animate-pulse rounded-xl" />
            ))}
          </div>
        ) : documents.length === 0 ? (
          <div className="text-center py-12">
            <span className="material-symbols-outlined text-4xl text-[#DDD0AD] mb-3 block">description</span>
            <p className="text-sm text-[#57534E] font-['Inter']">No documents yet.</p>
          </div>
        ) : (
              ...
              <div key={doc.id} className="flex items-center justify-between py-4">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-['Inter'] font-semibold text-[#181511] truncate">
                ...
                <div className="flex items-center gap-3 shrink-0 ml-4">
                  ...
                  {doc.file_url && (
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-xs font-['Inter'] font-bold text-[#A87813] hover:underline"
                    >
