---
title: "Guaranteed Rent vs Revenue Share: Which Pays More?"
date: 2025-06-06
excerpt: >
...
heroAlt: The facade of a Singapore condominium, illustrating guaranteed rent vs revenue share
---
...
Take an illustrative 4-bedroom co-living unit. Assume that at full occupancy, room income totals $6,800 a month across four rooms averaging $1,700 each. These are round numbers for the model, not a market quote, since room rates move with the building and micro-location; our piece on [co-living cost by district](/blog/coliving-cost-by-district-singapore) covers how they vary. Two illustrative offers on the table:
...
| Occupancy scenario | Average occupancy | Revenue share, monthly | Guaranteed rent, monthly | 3-year total gap |
|---|---|---|---|---|
| Strong, tight rental market | ~96% | $4,568 | $4,500 | Revenue share ahead by ~$2,450 |
| Stabilised, normal market | ~88% | $4,189 | $4,500 | Guaranteed ahead by ~$11,200 |
| Soft market | ~68% | $3,237 | $4,500 | Guaranteed ahead by ~$45,500 |
| Downturn or vacancy shock | ~45% | $2,142 | $4,500 | Guaranteed ahead by ~$84,900 |
...
A fixed rent is a contractual promise, not a fact about the property. If occupancy in the operator's wider portfolio craters, whether from a market shock, oversupply, or just bad management, the operator still owes you the same monthly number regardless. That promise is only as strong as the entity making it. Singapore's co-living sector has already lived through a real version of this. Hmlet, one of the region's larger operators at the time, ran 43 apartments at Lumiere, off Shenton Way, under a master lease with the building's owner. After the pandemic drove out expat tenants and kept new ones from arriving, the Hmlet subsidiary that held that lease, Hmlet Services Pte Ltd, filed for creditors' voluntary liquidation in November 2020, leaving the landlord with a lease its tenant could no longer honour. The units later had to be handed to a new operator, Cove, which took over their management from 1 June 2021.

This is exactly the pattern seen more broadly wherever fixed rent guarantees meet an operator in financial distress. A 2022 UK Insolvency Service report on company voluntary arrangements, covering 59 large retail, accommodation, and food and beverage tenants between 2011 and 2020, found that at least some landlords had their contractual rent compromised in 93% of cases, and where rent was compromised, the level of compromise ranged from 46% to 85%. That is commercial-lease data from the UK, not a study of co-living guarantees, but it shows how fixed rent promises behave once the tenant is in distress. The mechanism isn't unique to any one country: a guarantee is a corporate promise, and corporate promises fail exactly when the promiser is under the most pressure to keep them.
...
If you're weighing this decision against the broader question of whether co-living beats letting your unit as a single tenancy at all, that's covered from the ground up in our piece on [co-living yields versus single tenancy](/blog/coliving-yields-vs-single-tenancy-singapore). And before signing anything, vetting the operator itself, not just the structure they're offering, is its own exercise, covered in our piece on [co-living operator red flags](/blog/coliving-operator-red-flags-singapore).

## Talk through your own numbers

Every number in the table above is illustrative. Your unit's real breakeven point depends on its location, room mix, and the specific split or guarantee an operator actually puts in front of you. Lazybee works with condo and landed owners across Singapore on exactly this calculation, no obligation, just an honest look at what your specific unit could realistically earn under each structure. [Get in touch](https://lazybee.sg/) and we'll run the real numbers rather than a generic industry example.
