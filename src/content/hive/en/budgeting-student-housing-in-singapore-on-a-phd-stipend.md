...
![Working out a monthly budget on paper, splitting a PhD stipend between rent and living costs](/sketches/object__paperwork__fountain-pen-documents.jpg)
...
![Tracking a PhD stipend budget across rent, food and transport](/sketches/object__keyboard-mouse__hands-closeup.jpg)
...
![NUS Kent Ridge campus, where PhD stipends set the housing budget for postgraduate students](/sketches/loc-campus__nus-kent-ridge__overpass-trees.jpg)
...
Lazybee's rooms across [Chiltern Park, Ivory Heights, and Thomson Grove](https://www.lazybee.sg/hive/chiltern-park-ivory-heights-thomson-grove-guide) are all set up this way, with rent as one all-in figure rather than a headline number plus a stack of separate bills. If you're weighing the move-in costs and first-month math in more detail, our piece on [first-month moving costs in Singapore](https://www.lazybee.sg/hive/first-month-moving-costs-singapore) walks through that buffer calculation step by step. Current room availability and what's included in each listing are on [lazybee.sg](https://lazybee.sg), shown upfront so you can drop the real number straight into the table above.
