---
title: "Early Termination and Diplomatic Clauses in Co-living Leases in Singapore"
date: 2025-05-03
excerpt: >
...
tags: [Rules]
author: Lazybee Team
hero: /sketches/object__paperwork__fountain-pen-documents.jpg
heroAlt: Documents and a fountain pen on a desk, illustrating early termination and diplomatic clauses in co-living leases in singapore
---
...
| Term | What it is | When it kicks in |
|---|---|---|
| Diplomatic clause | A specific early-exit right tied to a stated trigger (job loss, transfer, posting) | Usually only after a minimum stay, with proof required |
| Break clause | The broader family of clauses that let either party end a fixed term early | Can be trigger-based (like a diplomatic clause) or open, with a fee |
| Notice period | The lead time required once an exit right is validly triggered | Runs from the day notice is correctly served, not the day you decide to leave |
...
Two points matter for enforceability. First, Singapore's penalty rule means a clause demanding payment on breach must be a genuine pre-estimate of loss, not a punitive figure. A wildly inflated "pay six months' rent if you leave early" clause risks being struck down as an unenforceable penalty if tested in court ([White & Case](https://www.whitecase.com/insight-alert/old-new-new-rule-against-penalties-singapore)). Deposits are treated separately, under the reasonable-earnest test above.

Second, forum matters. Singapore's Small Claims Tribunals hear residential tenancy disputes up to $20,000 (up to $30,000 by consent), covering deposits and early termination, but they explicitly do not cover licence arrangements ([PropertyGuru](https://www.propertyguru.com.sg/property-guides/how-can-the-small-claims-tribunals-help-singapore-tenants-and-landlords-in-settling-rental-disputes-10109)). The Judiciary's own eligibility page lists residential tenancy agreements of up to 2 years as claimable, but excludes the "license of any premises for any period of time" ([Singapore Courts](https://www.judiciary.gov.sg/civil/cases-eligible-small-claim)). Since most co-living rooms sit under a licence rather than a tenancy of the whole unit, a dispute over one will usually fall outside the Tribunals, so check how your agreement is classified and get legal advice on the right forum.

If you're weighing your options before signing anywhere, compare actual room terms rather than marketing pages. Lazybee's current room listings at [lazybee.sg](https://lazybee.sg) show the notice period and deposit terms upfront, so you know exactly what you're agreeing to before move-in.

## FAQ: Breaking a Lease, the Questions Nobody Asks Until It Is Urgent

**Can I break my co-living lease if I lose my job?**
Only if your agreement has a clause that covers it, most commonly a diplomatic clause requiring a minimum stay already served, written notice, and proof of the job loss. Without that clause, job loss alone is not a legal exit right.

**Does a diplomatic clause exist automatically in every lease?**
No. It only exists if it was negotiated and written into your specific agreement.

**How much notice do I actually need to give?**
Whatever your contract states, commonly around two months on longer leases, shorter on some co-living licences. The clock starts from valid written notice, not from your decision date.

**Will I lose my whole deposit if I leave early?**
Not automatically. Following 2024 Court of Appeal guidance, forfeiture depends on whether a genuine forfeiture right exists and whether the deposit amount was reasonable when agreed.

**What if my contract has no exit clause at all?**
Your realistic options are a mutual surrender negotiated with the landlord, or finding an approved replacement tenant. Both need the other side's agreement.

**Where do I take a dispute if things go wrong?**
Disputes over a residential tenancy of up to 2 years, worth up to $20,000 (or $30,000 if both sides consent), can go to the Small Claims Tribunals. The Tribunals exclude licences of premises, so co-living arrangements structured as licences fall outside them. Check the exact classification of your agreement first.
