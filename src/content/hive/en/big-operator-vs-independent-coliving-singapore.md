...
![A co-living licence agreement, where operator size shows up in the contract terms](/sketches/object__paperwork__fountain-pen-documents.jpg)
...
![A hand holding room keys, the handover moment that differs between large and independent operators](/sketches/object__keys__hand-holding-closeup.jpg)
...
- **A stamped tenancy or licence agreement.** An agreement only holds up in a Singapore court if it's been e-stamped with IRAS. An operator who avoids giving you a proper written, stampable agreement is a hard stop. Our piece on the difference between a [licence agreement and a tenancy agreement](/blog/licence-agreement-vs-tenancy-agreement-singapore) explains what should actually be in it.
- **Where the deposit goes.** A deposit paid into a personal bank account with no paper trail is far riskier than one paid to a registered company, since there's no separation between the operator's finances and yours if something goes wrong. Our piece on [security deposits in co-living](/blog/security-deposit-coliving-singapore) covers what's normal and what to push back on.
- **A real viewing, on video at minimum.** Photos alone, especially professional-looking ones reused across multiple listings, are a known scam pattern. Our guide to [viewing a room remotely](/blog/viewing-a-room-remotely-singapore) has a full checklist for exactly this.
...
![Hands at a keyboard comparing co-living operators in Singapore and their response times](/sketches/object__keyboard-mouse__hands-closeup.jpg)

## Big vs independent: the practical differences at a glance

| | Big operator | Independent operator |
|---|---|---|
| Maintenance | App/ticketing system, SLA-driven, backup staff if one person is out | Direct message to the owner, usually faster, no backup layer |
| Pricing | Sometimes gated behind an enquiry form | Usually published outright on the listing |
| Contract terms | Standardised, applied the same to every tenant | More negotiable, depends on the individual operator |
| Community | Programmed events, dedicated community role | Organic, depends who else lives there |
| Acquisition risk | Real and current (consolidation is active), lease usually survives | Lower acquisition risk, but higher risk of an under-resourced or informal setup if not vetted |
| Choice of location | Wide, dozens of buildings and neighbourhoods | Narrow, a handful of specific rooms |
...
At Lazybee, we're the second kind: three houses, pricing published on the room listing itself, and the person who answers your message is the same person who runs the building. We think that's a fair trade-off for the right tenant, and we'd rather you compare us honestly against the bigger names than take our word for it. Current rooms across Chiltern Park, Ivory Heights, and Thomson Grove are listed at [lazybee.sg](https://lazybee.sg), and you can [book a viewing](https://book.lazybee.sg) directly against the same calendar we use ourselves.

Sources: [HDB, Renting out a flat: regulations](https://www.hdb.gov.sg/managing-my-home/home-ownership/renting-out-a-flat-or-bedrooms/renting-out-a-flat/regulations); [IRAS, Stamp duty on renting a property](https://www.iras.gov.sg/taxes/stamp-duty/for-property/renting-a-property); [IRAS, Stamping a lease or tenancy](https://www.iras.gov.sg/digital-services/stamp-duty/stamping-lease-tenancy); [ACRA BizFile, for verifying an operator's registered entity and UEN](https://www.bizfile.gov.sg/).
