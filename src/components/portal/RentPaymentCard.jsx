  ...
  return (
    <div className="flex items-center gap-4 px-6 py-5">
      ...
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
        status === "PAID" ? "bg-green-50" : status === "OVERDUE" ? "bg-red-50" : "bg-[#EAC25A]"
      }`}>
      ...
      <div className="min-w-0 flex-1">
        <p className="font-['Inter'] font-bold text-sm text-[#181511]">{formatMonth(month)}</p>
      ...
      <div className="text-right shrink-0">
        <p className="font-['Hanken_Grotesk'] font-bold text-[#181511]">{formatSGD(rent_amount)}</p>
