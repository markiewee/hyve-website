...
const TOUR_STEPS = [
  ...
  {
    title: "Need Help?",
    text: "WhatsApp us anytime at +65 8069 5410 or email admin@lazybee.sg. We typically respond within an hour. Enjoy your stay!",
    icon: "support_agent",
    position: "center",
  },
];
      ...
      >
        <div className="bg-surface border border-border rounded-2xl p-6 w-[340px] max-w-[90vw]">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleNext}
              className="px-5 py-2 bg-accent text-white rounded-full font-['Inter'] font-bold text-sm hover:opacity-90 transition-opacity flex items-center gap-1.5"
            >
