        ...
        >
          ...
          <div className="no-print mt-4 flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#A87813] text-white text-sm font-semibold rounded-lg hover:bg-[#A87813] transition-colors font-['Inter']"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
